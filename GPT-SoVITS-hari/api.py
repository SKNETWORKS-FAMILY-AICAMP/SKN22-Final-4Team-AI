...
def get_sovits_weights(sovits_path):
    ...
    # ==========================================
    # [수정할 부분] 무조건 v3로 덮어씌워 버립니다!
    # ==========================================
    model_version = "v3"
    hps.model.version = "v3"
    logger.info("🚨 강제로 v3 모델 모드로 전환합니다!")
    # ==========================================
...
def get_tts_wav(
    ...
    # api.py의 730번째 줄 근처 (get_tts_wav 함수 내부)
        
    # [이 줄을 추가하세요!] API가 현재 가지고 있는 뇌(모델) 이름들을 출력합니다.
    print("🚨 현재 등록된 모델 이름들:", speaker_list.keys()) 
...
parser.add_argument("-cp", "--cut_punc", type=str, default="tech_girl", help="默认角色名 (기본 캐릭터 이름)")
